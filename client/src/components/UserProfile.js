...
const UserProfile = () => {
  ...
  const fetchPhoneNumber = async () => {
    try {
      ...
      const response = await axios.get(createApiUrl("api/user-profile/phone"), {
        headers: {
  ...
  const handleSavePhone = async () => {
    ...
    const formattedPhone = `(${tempPhoneNumber.slice(
      0,
      3
    )}) ${tempPhoneNumber.slice(3, 6)} ${tempPhoneNumber.slice(6)}`;
    ...
    try {
      ...
      const response = await axios.post(
        createApiUrl("api/user-profile/phone"),
  ...
  const handleSaveName = async () => {
    ...
    try {
      const token = await getAccessTokenSilently();
      const response = await axios.post(
        createApiUrl("api/auth/updateName"),
  ...
  const fetchEmail = async () => {
    try {
      const token = await getAccessTokenSilently();
      const response = await axios.get(createApiUrl("api/user-profile/email"), {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleSaveEmail = async () => {
    ...
    try {
      const token = await getAccessTokenSilently();
      const response = await axios.post(
        createApiUrl("api/user-profile/email"),
        { email: tempEmail },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async function handleAvatarUpload(event) {
    ...
    if (file) {
      ...
      try {
        const token = await getAccessTokenSilently();
        const response = await axios.post(
          createApiUrl("api/user-profile/upload_photo"),
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const fetchProfilePhoto = async () => {
    try {
      ...
      const token = await getAccessTokenSilently();
      const response = await axios.get(createApiUrl("api/user-profile/photo"), {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
